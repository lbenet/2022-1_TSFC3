...
function division_extendida(A::Intervalo, B::Intervalo)
		...
		if 0 ∉ B
			...
			return Intervalo(prevfloat(I.infimo), nextfloat(I.supremo))
			
		elseif 0 ∈ A && 0 ∈ B
			
			return Intervalo(-Inf,Inf)
			
		elseif A == B == Intervalo(0,0) 
			
		    return Intervalo(-Inf,Inf)
			
		elseif A.supremo < 0 && B.infimo < 0 < B.supremo 
			
			return Intervalo(prevfloat(A.supremo/B.infimo),nextfloat(A.supremo/B.supremo))
		...
		elseif 0 < A.infimo && B.infimo < 0 < B.supremo
			...
			if 1/B.supremo > 1/B.infimo 
			    ...
			    return Intervalo(prevfloat(A.infimo/B.supremo), nextfloat(A.infimo/B.infimo))
